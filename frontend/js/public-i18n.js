...
const pairs = [
  ...
  ['PAPAN DUKUNGAN','SUPPORT BOARD'],['TIM PENDUKUNG TERATAS','TOP SUPPORTER TEAMS'],['PINDAI UNTUK MENGIRIM DUKUNGAN','SCAN TO SEND YOUR SUPPORT'],
  ['Dukungan akan tampil setelah dipublikasikan oleh admin.','Support messages will appear after being published by an admin.'],
  ['LEADERBOARD BELUM TERSEDIA','LEADERBOARD NOT AVAILABLE'],['Peringkat supporter akan tampil setelah support card dipublikasikan.','Supporter rankings will appear after support cards are published.'],
  ['GREETING BELUM TERSEDIA','GREETINGS NOT AVAILABLE'],['Sambutan akan tampil setelah dipublikasikan oleh admin.','Greetings will appear after being published by an admin.'],
  ['JADWAL BELUM TERSEDIA','SCHEDULE NOT AVAILABLE'],['Jadwal pertandingan akan tampil setelah disimpan oleh admin.','Match schedules will appear after being saved by an admin.'],['Akan tampil setelah disimpan oleh admin.','It will appear after being saved by an admin.'],
  ['DATA MENUNGGU','DATA PENDING'],['FOTO BELUM TERSEDIA','PHOTO NOT AVAILABLE'],['Foto akan tampil setelah dipublikasikan melalui Admin Gallery.','Photos will appear after being published through Admin Gallery.'],['Upload foto cabor lain dari halaman admin Gallery.','Upload photos from other sports through the Admin Gallery.'],
  ...
  ['KLASEMEN BELUM TERSEDIA','STANDINGS NOT AVAILABLE'],['Group Standing akan tampil setelah disimpan oleh admin.','Group standings will appear after being saved by an admin.'],
